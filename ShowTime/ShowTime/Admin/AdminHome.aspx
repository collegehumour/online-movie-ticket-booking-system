<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="ShowTime.Admin.AdminHome" %>
<!DOCTYPE html>
        ...
        <asp:Table ID="Table2" runat="server" Width="100%">
            <asp:TableRow>
                ...
                <asp:TableCell HorizontalAlign="Right">
                    <asp:Button ID="Button2" runat="server" Text="Add Admin" OnClick="Button2_Click"/>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>                          
        </div>           
